...
import { DashboardData, DashboardQueryParams } from '../../features/dashboard/models/dashboard.models';
...
export class DashboardService {
  ...
  getDashboardData(params: DashboardQueryParams): Observable<DashboardData> {
    ...
    return this.http.get<{ success: boolean; data: DashboardData }>(this.API_URL, { params: httpParams }).pipe(
